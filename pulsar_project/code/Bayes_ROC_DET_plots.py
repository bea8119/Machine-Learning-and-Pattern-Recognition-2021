...
dcf_norm, dcf_min = DCF.DCF_vs_priorLogOdds(effPriorLogOdds, np.load('../data_npy/scores_MVG_K_fold_calibrated.npy'), trueL_ordered) # Need to create
print('Done.\n')
dcf_list.append(dcf_norm)
dcf_list.append(dcf_min)
print('Calculating DCF and minDCF for calibrated SVM...')
dcf_norm, dcf_min = DCF.DCF_vs_priorLogOdds(effPriorLogOdds, np.load('../data_npy/scores_SVM_K_fold_calibrated.npy'), trueL_ordered) # Need to create
print('Done.\n')
dcf_list.append(dcf_norm)
dcf_list.append(dcf_min)
param_list = [
